...
let BasicRegComponent = /*@__PURE__*/ (() => {
    ...
    BasicRegComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BasicRegComponent, selectors: [["app-basic-reg"]], decls: 62, vars: 0, consts: [[1, "login", "p-fixed", "d-flex", "text-center", "bg-primary", "common-img-bg"], [1, "auth-fluid"], [1, "row"], [1, "col-sm-12"], [1, "login-card", "card-body", "auth-body"], [1, "md-float-material"], [1, "text-center"], ["src", "assets/images/auth/logo-dark.png", "alt", "Smart-Deed"], [1, "auth-box"], [1, "row", "m-b-20"], [1, "col-md-12"], [1, "text-center", "txt-primary"], [1, "input-group"], ["type", "text", "placeholder", "Choose Username", 1, "form-control"], [1, "md-line"], ["type", "text", "placeholder", "Your Email Address", 1, "form-control"], ["type", "password", "placeholder", "Choose Password", 1, "form-control"], ["type", "password", "placeholder", "Confirm Password", 1, "form-control"], [1, "row", "m-t-25", "text-left"], [1, "checkbox-fade", "fade-in-primary"], ["type", "checkbox", "value", ""], [1, "cr"], [1, "cr-icon", "icofont", "icofont-ui-check", "txt-primary"], [1, "text-inverse"], ["href", "javascript:;"], [1, "row", "m-t-30"], ["type", "button", 1, "btn", "btn-primary", "btn-md", "btn-block", "waves-effect", "text-center", "m-b-20"], [1, "col-md-10"], [1, "text-inverse", "text-left", "m-b-0"], [1, "text-inverse", "text-left"], [1, "col-md-2"], ["src", "assets/images/auth/Logo-small-bottom.png", "alt", "small-logo.png"]], template: function BasicRegComponent_Template(rf, ctx) {
            if (rf & 1) {
...
/* harmony import */ var _basic_reg_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./basic-reg.component */ "Knfp");
...
let BasicRegRoutingModule = /*@__PURE__*/ (() => {
...
/* harmony import */ var _basic_reg_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./basic-reg.component */ "Knfp");
/* harmony import */ var _basic_reg_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./basic-reg-routing.module */ "QYZW");
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BasicRegModule, { declarations: [_basic_reg_component__WEBPACK_IMPORTED_MODULE_2__["BasicRegComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _basic_reg_routing_module__WEBPACK_IMPORTED_MODULE_3__["BasicRegRoutingModule"],
            _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]] });
})();
...
//# sourceMappingURL=7-es2015.ffefd42c90e9a78a9a29.js.map